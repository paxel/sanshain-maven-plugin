...
mvn io.github.paxel.sanshain:sanshain-maven-plugin:2.1.0:provide -DconfigFile=sanshain.yaml -Dsanshain.token=$TOKEN

echo ""
echo "--- Step 2: Second Provide (should skip) ---"
OUTPUT=$(mvn io.github.paxel.sanshain:sanshain-maven-plugin:2.1.0:provide -DconfigFile=sanshain.yaml -Dsanshain.token=$TOKEN)
...
mvn io.github.paxel.sanshain:sanshain-maven-plugin:2.1.0:require -DconfigFile=sanshain.yaml -Dsanshain.token=$TOKEN

echo ""
echo "--- Step 5: Second Require (should skip with 304) ---"
OUTPUT=$(mvn io.github.paxel.sanshain:sanshain-maven-plugin:2.1.0:require -DconfigFile=sanshain.yaml -Dsanshain.token=$TOKEN)
